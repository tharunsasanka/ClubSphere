...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/darkmode.css">
</head>
<body>
...
<section class="hero d-flex align-items-center justify-content-center text-center">
    <div class="container">
        ...
        <!-- ✅ Added button to go to event list via servlet -->
        <a href="<%=request.getContextPath()%>/eventList" class="btn btn-lg btn-primary mt-3">View All Events & Clubs</a>
    </div>
</section>
